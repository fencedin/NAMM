...
import com.fencedin.namm.network.PacketHandler;
...
public class TileEntityNAMM extends TileEntity
{
    ...
    {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntityNAMM(this));
    }
}
